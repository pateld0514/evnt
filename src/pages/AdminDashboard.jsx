...
import { CheckCircle, XCircle, Clock, ExternalLink, Loader2, Users, Store, FileText, DollarSign, Activity, Bell, Trash2, Star } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <Tabs defaultValue="pending" className="space-y-4 md:space-y-6">
          <TabsList className="grid w-full grid-cols-3 md:grid-cols-6 bg-black text-white h-auto">
            ...
            <TabsTrigger value="users" className="py-2 md:py-3 text-xs md:text-sm font-bold">
